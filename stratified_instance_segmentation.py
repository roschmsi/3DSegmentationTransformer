...
from trainer.trainer import StratifiedInstanceSegmentation, RegularCheckpointing
...
def get_parameters(cfg: DictConfig):
    ...
    model = StratifiedInstanceSegmentation(cfg)
...
@hydra.main(config_path="conf", config_name="config_stratified_instance_segmentation.yaml")
